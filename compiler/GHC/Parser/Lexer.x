      ...
      where
        go start_loc curLine prevLines input@(AI end_loc _) = case alexGetChar' input of
          ...
          where
            ...
            locatedLine = L lineSpan (reverse curLine)
            commentLines = fmap (fmap mkHsDocStringChunk) $ NE.reverse $ locatedLine :| prevLines
...
nested_doc_comment span buf _len = withLexedDocType worker
  where
