...
-- We export this type from this module instead of GHC.Stg.InferTags.Types, because it's used by more than the analysis itself.
-- This way we can avoid module loops.
