...
type TgStgTopBinding = GenStgTopBinding 'InferTagged
type TgStgBinding    = GenStgBinding    'InferTagged
type TgStgExpr       = GenStgExpr       'InferTagged
type TgStgRhs        = GenStgRhs        'InferTagged
type TgStgAlt        = GenStgAlt        'InferTagged
