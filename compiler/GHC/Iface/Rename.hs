...
rnIfaceDCo IfaceReflDCo
  = return IfaceReflDCo
rnIfaceDCo (IfaceGReflRightDCo mco)
  = IfaceGReflRightDCo <$> rnIfaceMCo mco
rnIfaceDCo (IfaceGReflLeftDCo  mco)
  = IfaceGReflLeftDCo  <$> rnIfaceMCo mco
...
rnIfaceDCo (IfaceTransDCo dco1 dco2)
  = IfaceTransDCo <$> rnIfaceDCo dco1 <*> rnIfaceDCo dco2
